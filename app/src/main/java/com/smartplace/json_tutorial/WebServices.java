...
public class WebServices {
    ...
    private static final String SERVER_URL = "http://ec2-54-68-197-173.us-west-2.compute.amazonaws.com/";

    private static final String PATH_GET_NAMES= "/welcome/getChespiritoAndroid";
